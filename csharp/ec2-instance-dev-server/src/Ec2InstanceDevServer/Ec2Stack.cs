...
internal class Ec2Stack : NestedStack
{
  ...
  public string KeyPairName { get; set; } = "ec2-key-pair-us-east-1";
  ...
  public Ec2Stack(Construct scope, string id, IVpc vpc, INestedStackProps props = null) : base(scope, id, props)
  {
    ...
    KeyPair keypair = (KeyPair)KeyPair.FromKeyPairName(this, "dev-server-key-pair", KeyPairName);
    /*
  ...
  private static BlockDevice GetBlockDevice()
  {
    ...
    {
      DeviceName = "/dev/sda1",
      Volume = BlockDeviceVolume.Ebs(8, new EbsDeviceOptions
      {
